...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const allMapData = {
        ...
        'map-image-lot5': { // Added wrapper object and mapType
            mapType: 'individual-lot', // <-- NEW: Identify this map's type
            lots: [
                { id: 'Lot1', name: 'The Point - Home 1', href: 'the_point.html#lot1', beds: '8', baths: '8.5', sqft: '10,323', coords: '217,958,297,748,477,765,482,782,492,885,408,1048,321,1002' },
                { id: 'Lot2', name: 'The Point - Home 2', href: 'the_point.html#lot2', beds: '5', baths: '5.5', sqft: '10,290', coords: '81,918,71,556,120,533,143,528,215,523,215,679,297,748,217,961' },
                { id: 'Lot3', name: 'The Point - Home 3', href: 'the_point.html#lot3', beds: '6', baths: '6.5', sqft: '9,279', coords: '215,525,253,514,282,501,442,616,445,663,456,710,478,765,298,747,216,680' },
                { id: 'Lot4', name: 'The Point - Home 4', href: 'the_point.html#lot4', beds: '6', baths: '6.5', sqft: '8,611', coords: '282,500,325,470,402,359,416,326,536,414,472,508,454,550,441,617' },
                { id: 'Lot5', name: 'The Point - Home 5', href: 'the_point.html#lot5', beds: '5', baths: '5.5', sqft: '13,294', coords: '416,325,423,281,420,147,433,122,460,100,517,92,545,104,565,128,592,305,599,327,536,415' }
            ]
        },
        'map-image-lot10': { // Added wrapper object and mapType
            mapType: 'individual-lot', // <-- NEW: Identify this map's type
            lots: [
                ...
                { id: 'Home7', name: 'Cliffside Home 7', href: 'cliffside.html#lot10-9', beds: '4', baths: '4.5', sqft: '9,042', coords: '308,593,160,450,142,306,216,256,205,247,200,238,203,227,209,220,270,196,326,182,441,184,443,501,349,472' }
            ]
        },
        'map-image-lot13': { // Added wrapper object and mapType
            mapType: 'individual-lot', // <-- NEW: Identify this map's type
            lots: [
                { id: 'Home1', name: 'The Bluffs - Home 1', href: 'the_bluffs.html#lot13-1', beds: '3', baths: '3.5', sqft: '6,566', coords: '393,785,730,785,963,691,1158,735,1171,763,1185,782,1205,807,1237,829,1270,842,1297,849,1322,849,1351,847,1371,842,1393,834,1420,820,1440,805,1458,787,1472,765,1485,740,1495,720,1544,711,1631,1042,1279,1134,720,1471,678,1471' },
                { id: 'Home2', name: 'The Bluffs - Home 2', href: 'the_bluffs.html#lot13-2', beds: '6', baths: '6.5', sqft: '9,900', coords: '393,785,327,624,106,205,1064,0,1079,2,1072,25,1077,52,1200,280,1223,312,1240,329,1262,347,1287,361,1334,379,1317,495,1279,500,1247,515,1213,535,1188,560,1168,589,1156,619,1148,646,1146,676,1148,698,1158,733,960,691,728,782' }
            ]
        },
        'map-image-lot14': { // Added wrapper object and mapType
            mapType: 'individual-lot', // <-- NEW: Identify this map's type
            lots: [
                { id: 'Home3', name: 'The Bluffs - Home 3', href: 'the_bluffs.html#lot14-1', beds: '6', baths: '6.5', sqft: '12,702', coords: '249,1479,225,826,342,917,574,1002,618,975,676,1054,667,1069,661,1092,659,1113,661,1133,667,1154,676,1171,688,1186,702,1198,717,1209,738,1221,825,1255,986,1304,969,1302,957,1307,931,1337' },
                { id: 'Home4', name: 'The Bluffs - Home 4', href: 'the_bluffs.html#lot14-2', beds: '10', baths: '10.5', sqft: '13,681', coords: '225,823,225,781,266,177,828,51,1016,701,875,1054,869,1060,858,1040,840,1025,822,1011,799,1002,767,999,743,1002,714,1016,700,1028,676,1051,618,973,574,1002,340,917' },
                { id: 'Home5', name: 'The Bluffs - Home 5', href: 'the_bluffs.html#lot14-3', beds: '4', baths: '4.5', sqft: '7,223', coords: '869,1062,878,1050,1016,699,1244,743,1229,749,1291,889,1352,939,1291,1041,1177,1167,1171,1187,1139,1179,1127,1211,1147,1217,1139,1249,925,1182,890,1170,881,1158,878,1149,878,1141,881,1114,878,1085' },
                { id: 'Home6', name: 'The Bluffs - Home 6', href: 'the_bluffs.html#lot14-4', beds: '4', baths: '4.5', sqft: '7,330', coords: '1171,1189,1177,1166,1291,1043,1352,937,1294,888,1578,765,1610,756,1630,753,1651,756,1674,759,1689,762,1703,771,1864,870,1876,879,1882,896,1882,911,1876,926,1850,952,1815,984,1788,1002,1747,1031,1417,1195,1376,1221,1343,1242' }
            ]
        }
    };
                ...
                polygon.addEventListener('click', (event) => {
                    ...
                    if (clickedLotHref) {
                        if (clickedLotHref.includes('.html')) {
                            window.location.href = clickedLotHref;
                        } else {
