!(function (t, e, a) {
  ...
  var n,
    ...
    M = !(
      !e.nectarOptions ||
      !e.nectarOptions.smooth_scroll ||
      "true" !== e.nectarOptions.smooth_scroll
    ),
    W = !(
      !e.nectarOptions ||
      !e.nectarOptions.body_border_func ||
      "vignette" != e.nectarOptions.body_border_func
    ),
    B = !(
      !e.nectarOptions ||
      !e.nectarOptions.body_border_mobile ||
      "1" !== e.nectarOptions.body_border_mobile
    ),
    F = r.find(".body-border-top").height(),
    L = [],
    q = [],
    P = [],
    j = [],
    ...
    pt = !1,
    ft = {},
    gt = { animating: "false", perspect: "not-rolled", inUse: !1 },
    mt = { $usingFullScreenRows: !1 };
  f.length > 0 &&
  ...
  var bt = {
    ...
    getWindowSize: function () {
      (bt.winH = e.innerHeight),
        (bt.winW = e.innerWidth),
        (bt.adminBarHeight = u.length > 0 ? u.height() : 0),
        (bt.secondaryHeaderHeight =
          c.length > 0 && "none" != c.css("display") ? c.outerHeight() : 0),
        (bt.footerOuterHeight = m.length > 0 ? m.outerHeight() : 0);
    },
    scrollTop: 0,
    clientX: 0,
    clientY: 0,
    ...
    scrollPosRAF: function () {
      (bt.scrollTop = e.scrollY || s.scrollTop()),
        requestAnimationFrame(bt.scrollPosRAF);
    },
    bindEvents: function () {
      bt.usingMobileBrowser ||
        (M ||
          s.on("scroll", function () {
            bt.scrollTop = bt.scrollPosMouse();
          }),
        a.addEventListener("mousemove", function (t) {
          (bt.clientX = t.clientX), (bt.clientY = t.clientY);
        })),
        s.on("resize", bt.getWindowSize),
        e.addEventListener("orientationchange", bt.getWindowSize);
    },
    init: function () {
      (u = t("#wpadminbar")),
        this.getWindowSize(),
        (this.usingPhoneBrowser = !!(bt.usingMobileBrowser && bt.winW < 690)),
        (this.scrollTop = this.scrollPosMouse()),
        this.bindEvents(),
        (this.usingFrontEndEditor = void 0 !== e.vc_iframe);
    },
  };
  (e.nectarDOMInfo = bt), bt.init();
  var wt,
    yt = {
  ...
  function $t(t, e) {
    (this.lastX = bt.clientX),
      (this.lastY = bt.clientY),
      (this.$el = t),
      (this.iconType = e),
      (this.timeout = !1),
      (this.overEl = !1),
  ...
  function It() {
    t('.wpb_gallery_slidesflickity_static_height_style .cell[data-lazy="true"]')
      .length > 0 && (Tt(), s.on("smartresize", Tt));
  }
  function Et() {
    ...
    (j = []),
      ...
      t(".nectar-flickity:not(.masonry)").each(function (e) {
        j.push(new Ot(t(this), e));
      }),
      t(".nectar-carousel.nectar-flickity:not(.masonry)").length > 0 &&
        (bt.usingMobileBrowser
          ? e.addEventListener("orientationchange", zt)
          : s.on("resize", zt));
  }
  function Ot(t, e) {
    (this.$el = t),
  ...
  function zt() {
    var e = bt.usingMobileBrowser ? 200 : 0;
    setTimeout(function () {
      t(
  ...
  function At() {
    t(
      ...
      var e = t(this),
        ...
        n = t(this).find("> ul.sub-menu, > .nectar-global-section-megamenu");
      if (e) {
        if (n.width() + e.offset().left > bt.winW)
          return t(this).addClass("align-middle"), !0;
        t(this)
          .find("> ul.sub-menu, > .nectar-global-section-megamenu")
          .css({
            right:
              a.width() -
      ...
      t(
        ...
        if (e && n.length > 0) {
          ...
          d.left < 0
            ...
            : d.left + l > bt.winW && n.css({ right: "0px", left: "auto" });
        }
      });
  }
  function Mt() {
    ...
    t(
      "header#top nav:not(.left-side):not(.right-side) > ul > li.megamenu:not(.width-50):not(.width-75) > .sub-menu, header#top nav:not(.left-side):not(.right-side) > ul > li.megamenu:not(.width-50):not(.width-75) > .nectar-global-section-megamenu"
    ).css({
  ...
  function Wt() {
    bt.winW < 1e3 && "1" == r.attr("data-responsive")
    ...
    0 != t(".carousel").length &&
      ("undefined" != typeof SalientRecentProjectsCarousel &&
        t("ul.carousel.portfolio-items").each(function (e) {
          rt[e] = new SalientRecentProjectsCarousel(t(this));
        }),
      ...
      s.on("smartresize.carouselHeightCalcs", jt));
  }
  function Ft() {
  ...
  function Pt() {
    (0 === t(".products-carousel").length &&
      ...
      (t(".products-carousel").each(function (e) {
        new qt(t(this), "legacy", e);
      }),
      (J = []),
      t(".nectar-woo-flickity").each(function (e) {
        J.push(new qt(t(this), "flickity", e));
      }));
  }
  function jt() {
    t(
  ...
  function Yt() {
    0 !== t(".carousel.clients").length &&
      ...
      s.off("smartresize.clientsCarouselHeight", Rt),
      s.on("smartresize.clientsCarouselHeight", Rt));
  }
  function Rt() {
    var e = 0;
  ...
  function Gt() {
    var e;
    if (
      (r.is('[data-header-format="left-header"]') && bt.winW >= 1e3) ||
      r.is('[data-hhun="1"]') ||
      ...
      ((c.length > 0 && r.is(".material")) ||
        (c.length > 0 && !r.is(".material") && bt.winW < 1e3)) &&
        (n -= bt.secondaryHeaderHeight),
        (e =
    ...
    if (bt.winW >= 1e3 && t('#header-outer[data-condense="true"]').length > 0) {
      ...
      e =
        ...
        parseInt(bt.secondaryHeaderHeight);
    }
    return e;
  }
  function Ut(t, e, n) {
  ...
  function ee(t, n, i) {
    var s = e.scrollY || a.documentElement.scrollTop,
      r = ((t = t || 0), (i = i || "easeOutSine"), 0),
      o = Math.max(0.1, Math.min(Math.abs(s - t) / 1300, 1.3)),
      l = {
  ...
  function ae() {
    var e =
        ...
        "1000" != r.attr("data-header-breakpoint")
          ...
          : 1e3,
      a = !1;
    return 1e3 != e && bt.winW > 1e3 && bt.winW <= e && (a = !0), a;
  }
  function ne(t) {
  ...
  (e.nectarState = yt),
    ...
    ($t.prototype.viewportTracking = function () {
      var a = this;
    ...
    ($t.prototype.createMarkup = function () {
      var e = this;
      if (
        (("view-indicator" !== this.iconType &&
          "horizontal-movement" !== this.iconType) ||
      ...
      if (
        ...
        if (
          ...
          t("body").append(
            ...
            setTimeout(function () {
              (e.lastY = bt.clientY), (e.lastX = bt.clientX), e.viewRAF();
            }, 100);
    ...
    ($t.prototype.mouseBind = function () {
      var e = this;
      if ("horizontal-movement" === this.iconType)
        ...
        var a = e.$el.is("[data-indicator-text-color]")
          ...
          r = e.$el.find(".nectar-post-grid-item");
        e.$el.is("a") && (r = e.$el),
          r.off(),
    ...
    ($t.prototype.updatePos = function () {
      (this.lastY = Dt(this.lastY, bt.clientY, this.lerpDamp)),
        (this.lastX = Dt(this.lastX, bt.clientX, this.lerpDamp));
    }),
    ($t.prototype.parallaxIcon = function () {
      (this.parallaxLastX =
        Dt(
          this.parallaxLastX,
          parseInt(bt.clientX) - parseInt(this.lastX),
          this.lerpDamp
        ) / 1.65),
        (this.parallaxLastY =
          Dt(
            this.parallaxLastY,
            parseInt(bt.clientY) - parseInt(this.lastY),
            this.lerpDamp
          ) / 1.65),
        this.$innerParallaxEl.length > 0 &&
          (this.$innerParallaxEl[0].style.transform =
            "translateX(" +
            Nt(this.parallaxLastX, 12, -12) +
            "px) translateY(" +
            Nt(this.parallaxLastY, 12, -12) +
            "px)");
    }),
    ($t.prototype.dragRAF = function () {
      this.updatePos(),
    ...
    (Ot.prototype.setup = function () {
      ...
      if (
        ...
        var n = this.$el.is("[data-ticker-speed]")
            ...
            : "slow",
          i = this.$el.is("[data-ticker-direction]")
            ? this.$el.attr("data-ticker-direction")
            : "default";
        (this.tickerSpeed = "slow" === n ? 0.4 : "medium" === n ? 1.2 : 2),
          "reverse" === i && (this.tickerSpeed = -1 * this.tickerSpeed),
          (this.$wrapAround = !0),
          (this.$paginationBool = !1);
      }
      (this.$flickity_autoplay = !1),
        ...
        this.$el.hasClass("nectar-simple-slider") &&
          ...
          this.$el.is('[data-simple-slider-transition="fade"]') &&
            (this.fadeBool = !0));
      var s = this.$el.parents(".toggle").length > 0;
      !bt.usingFrontEndEditor &&
      !(function () {
      ...
      !s &&
      !1 === mt.$usingFullScreenRows
        ? this.lazyInit()
        : this.init();
    }),
    (Ot.prototype.lazyInit = function () {
      var t = this;
      (this.observer = new IntersectionObserver(
        function (e) {
          e.forEach(function (e) {
    ...
    (Ot.prototype.init = function () {
      (this.instance = new Flickity(".nectar-flickity.instance-" + this.index, {
        ...
        accessibility: !1,
        fade: this.fadeBool,
        dragThreshold: bt.usingMobileBrowser ? 25 : 3,
        arrowShape: this.$arrowShape,
      })),
        this.events();
    }),
    (Ot.prototype.trackView = function () {
      var t = this;
    ...
    (Ot.prototype.fullWidthOverlow = function () {
      this.$el.is('[data-overflow="visible"]') &&
    ...
    (Ot.prototype.sharedEvents = function () {
      var e,
        a,
        n = this,
        i = this.$el,
    ...
    (Ot.prototype.tickerRotate = function () {
      this.tickerPaused ||
        1 != this.inView ||
    ...
    (Ot.prototype.imageCaptionWidth = function () {
      this.$el.find(".item-meta").each(function () {
        t(this).css({ width: t(this).parent().find("img").width() });
      });
    }),
    (Ot.prototype.simpleSlideBGConnection = function () {
      var e =
    ...
    (Ot.prototype.simpleSliderStyle = function () {
      var e = this.$el,
        a = this;
      if (
    ...
    (Ot.prototype.galleryParallax = function () {
    ...
    (Ot.prototype.visualizedTotalControls = function () {
      var e = this.$el,
        a = !!(
      ...
      0 != this.$el.find(".visualized-total").length ||
        ...
        bt.usingMobileBrowser ||
          ((Y[this.index] = new $t(this.$el, "horizontal-movement")),
          this.instance.on("dragMove", function (t, e) {
            (bt.clientY = e.clientY), (bt.clientX = e.clientX);
          }),
    ...
    (Ot.prototype.fixedContentStyle = function () {
      var a = bt.usingMobileBrowser,
        n = this.$el,
        i = this;
      this.$flickity_stored_autoplay &&
    ...
    (qt.prototype.setup = function () {
      !bt.usingFrontEndEditor && "IntersectionObserver" in e
        ? this.lazyInit()
        : this.init();
    }),
    ...
    (qt.prototype.lazyInit = function () {
      var t = this;
      (this.observer = new IntersectionObserver(
        function (e) {
          e.forEach(function (e) {
    ...
    (qt.prototype.legacyCarousel = function () {
    ...
    (qt.prototype.flickityCarousel = function () {
      var a = this.$el;
      ...
      if (
        ...
        bt.usingMobileBrowser ||
          (Y.push(new $t(this.$el, "horizontal-movement")),
        ...
        Lt({ data: { wooFlickity: p, wooFlickityCount: u } }),
          this.instance.on(
            "select.flickity",
      ...
      this.$el.removeClass("animated-in"), ba();
    }),
    ...
    (function (t) {
      ...
      (n.VERSION = "3.2.0"),
        ...
        (n.prototype.process = function () {
          if (yt.preventScroll) return !0;
          var e,
            a = bt.scrollTop + this.options.offset + this.pageSubmenuHeight,
    ...
    setTimeout(function () {
      ...
      t('body[data-ls="pretty_photo"]').length > 0
        ...
        : t('body[data-ls="fancybox"]').length > 0 &&
          (t().fancybox ? ce() : setTimeout(ce, 200));
    }, 60);
  }
  function ue() {
    t(ht + " .wpb_animate_when_almost_visible").each(function () {
      var e = t(this),
        a = 1 == ut ? "200%" : "90%",
        n = new Waypoint({
          element: e[0],
  ...
  function fe() {
    t(ht + ".nectar-milestone").each(function () {
      var e = 1 == ut ? "250%" : "98%";
      bt.usingMobileBrowser && "98%" == e && (e = "110%");
      var a = 0;
    ...
    r.on("click", ".tabbed > ul li:not(.cta-button) a", function (a) {
      if (
        ((function (a) {
          ...
          c.find(".nectar-progress-bar").length > 0 && Ke(),
            ...
            (c.find(".parallax-layer").length > 0 ||
              ...
              Ye(),
            Fe(),
            c.find(".nectar-milestone").length > 0 && fe(),
            ...
            c.find(".nectar-fancy-ul").length > 0 && Oe(),
            c.find(".nectar-split-heading").length > 0 && Ue(),
            c.find('.wpb_column[data-border-animation="true"]').length > 0 &&
              ta(),
            c.find(".wpb_animate_when_almost_visible").length > 0 && ue(),
            c.find(".nectar-animated-title").length > 0 && ma(),
            c.find(".nectar-highlighted-text").length > 0 && va(),
            c.find(".nectar_food_menu_item").length > 0 && aa(),
            c.find('.nectar-post-grid:not([data-animation="none"])').length >
              0 && ga(),
            c.find(".nectar-waypoint-el").length > 0 && ea(),
            ...
            c.find(".svg-icon-holder").each(function (e) {
              ...
              setTimeout(function () {
                ...
                a.is("[data-animation-delay]") &&
                  ...
                  "false" == a.attr("data-animation")
                    ? (a.css("opacity", "1"),
                      q[a.find("svg").attr("id").slice(-1)].finish())
                    : (q[a.find("svg").attr("id").slice(-1)].reset(),
                      (st[e] = setTimeout(function () {
                        q[a.find("svg").attr("id").slice(-1)].play();
                      }, t)));
              }, 150);
            }),
            ...
            0,
            a.parent().parent().find(".magic-line").length > 0 && ge(a),
            t(e).trigger("nectar-tab-changed");
        })(t(this)),
        void 0 !== a.originalEvent &&
          bt.winW < 1e3 &&
          0 == mt.$usingFullScreenRows &&
          !t(this).parents(".disable-mobile-tab-scroll"))
      ) {
        var n = t(this).closest(".tabbed").find("> ul");
        if (n.height() > 350) {
          var i = n.offset().top + n.height() - bt.adminBarHeight;
      ...
      t(".nectar-scrolling-tabs").each(function (e) {
        bt.usingFrontEndEditor || (lt[e] = new ve(t(this)));
      });
    var a = !1;
      ...
      t('.toggles.accordion:not([data-starting="closed"])').each(function () {
        if (0 == t(this).find('.toggle[data-inner-wrap="true"]').length)
          t(this)
            ...
            .find("> div")
            .show();
        else if (!bt.usingFrontEndEditor) {
  ...
  function Ee() {
    if (t(".morphing-outline").length > 0) {
      ...
      t(".morphing-outline").each(function (n) {
        ...
        de(e, "morphing-outlines");
    }
  }
  function Oe() {
    t(ht + ".nectar-fancy-ul").each(function () {
    ...
    if (
      ...
      t(".carousel-outer")
        ...
        t(
          ...
          var a =
            ...
            s =
              ...
              (t(".body-border-right").length > 0 &&
                ...
                : 0;
          if (1 == t("#boxed").length) {
            var l = o >= 690 ? parseInt(t(".main-content").width()) : h;
            (r =
          ...
          var g = 0;
          t(this).hasClass("carousel-wrap") && (g = 1),
            t(this).hasClass("portfolio-items") && (g = 5);
          var m = 1 == t("#boxed").length ? r + parseInt(2 * i) : d - s + g;
          if (
            (0 == t("#boxed").length &&
            ...
            (r =
              0 == t("#nectar_fullscreen_rows").length
                ...
                : parseInt(t(this).parents(".container").width())),
              0 != t("#boxed").length
                ? (m = 1 == t("#boxed").length ? r + parseInt(2 * i) : d + g)
                : ((m =
                    1 == t("#boxed").length
                      ? r + parseInt(2 * i)
                      : d - s - 0.025 * (d - s) + g),
                  (n = d - s <= r ? r : d - s - 0.025 * (d - s)),
                  (i = Math.ceil((n - r) / 2)));
            ...
            if (
              ...
              m =
                1 == t("#boxed").length
                  ? r + parseInt(2 * i)
                  : d - s - Math.ceil(0.02 * (d - s)) + g;
              var v = d - s <= r ? r : d - s - 0.02 * (d - s);
              i = Math.ceil((v - r) / 2 + 2);
            }
  ...
  function We(t) {
    if (
      ...
      !bt.usingMobileBrowser || 0 != this.persistOnMobile)
    ) {
      this.setType(),
        this.calculatePos(),
        this.trackView(),
  ...
  function Be(t, e, a, n) {
    (this.$el = t),
      ...
      t.parents(".nectar-sticky-tabs").length > 0 ||
        ...
        t.parents(".nectar-global-section-megamenu").length > 0 ||
        (this.setup(), this.update());
  }
  function Fe() {
    for (var t = 0; t < D.length; t++) D[t].resize();
    for (t = 0; t < G.length; t++) G[t].resize();
    for (t = 0; t < Z.length; t++) Z[t].calculatePos();
    for (t = 0; t < Q.length; t++) Q[t].calculatePos();
    Waypoint.refreshAll();
  }
  function Le(t) {
    (this.$el = t),
        ...
        t(
          ...
          imagesLoaded(t(this), function (e) {
            t(e.elements[0]).is('[data-scroll-animation="true"]') &&
              ...
              0 ===
                t(e.elements[0]).parents(".nectar-global-section-megamenu")
                  .length &&
              Z.push(new We(t(e.elements[0])));
          });
        }),
        Ye();
      var e = 0;
      t(
        ...
        t(this).is("[data-n-parallax-bg][data-parallax-speed]")
          ? ((D[e] = new Be(
              t(this),
              ".parallax-layer",
              Pe(t(this).attr("data-parallax-speed")),
              "regular"
            )),
            e++)
          : 0 == t(this).find('[data-parallax-speed="fixed"]').length &&
            (t(this).hasClass("nectar-slider-wrap")
              ...
              : (t(this).find(".row-bg.using-image").length > 0 &&
                  (D[e] = new Be(
                    t(this),
                    ".row-bg.using-image",
                    Pe(t(this).find(".row-bg").attr("data-parallax-speed")),
                    "regular"
                  )),
                t(this).find("> .nectar-video-wrap").length > 0 &&
                  (D[e] = new Be(
                    t(this),
    ...
    (bt.usingMobileBrowser &&
      ...
      t(
        ...
        if (
          ...
          (e = !1),
            ...
            (e && !bt.usingFrontEndEditor)
              ...
              : t(this)
                  .find(".video-wrap")
                  .css({
                    height: Math.ceil(0.25 * bt.winH) + t(this).outerHeight(!0),
                  });
          ...
          var o = ".row-bg, > .nectar-video-wrap .nectar-video-inner",
          ...
          var d =
            t(this).find(o + '[data-parallax-speed="fast"]').length > 0
              ? 60
              : 0;
          0 == t(this).parents("#page-header-bg").length &&
            t(this)
              .find(o)
              .css({
                height:
                  Math.ceil(bt.winH * Pe(l)) + t(this).outerHeight(!0) + d,
              });
        }
      });
  }
  ...
  function Qe() {
    var a = 1 == ut ? "500%" : "88%",
      n = 1 == ut ? "500%" : "70%",
      i = 1 == ut ? "500%" : "70%";
    t(ht + ".img-with-animation").each(function (e) {
      var n = t(this),
      ...
      t(ht + ".nectar_cascading_images").each(function () {
        var e = t(this),
      ...
      t(ht + '.wpb_column.has-animation[data-animation*="reveal"]').each(
        function () {
          var e = O;
          t(this)[0].hasAttribute("data-animation-easing") &&
  ...
  function Ue() {
    t(ht + ".nectar-split-heading:not(.custom-trigger)").each(function (e) {
      var a = 1 == ut ? "500%" : "bottom-in-view";
      t(this)[0].hasAttribute("data-animation-offset") &&
        1 != ut &&
                ...
                setTimeout(function () {
                  if (
                    ...
                    n.is('[data-stagger="true"]') &&
                      ...
                      n.is('[data-m-rm-animation="true"]') && bt.winW < 1e3
                        ? n
                            .find("> * > span .inner")
      ...
      t(ht + ".nectar-split-heading.scroll-timeline").each(function (e) {
        if (!0 === mt.$usingFullScreenRows)
          var a = t(this),
            n = new Waypoint({
              element: a[0],
              handler: function () {
  ...
  function Ke() {
    var e = 1 == ut ? "500%" : "bottom-in-view",
      a =
        t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 &&
        bt.usingMobileBrowser
          ? ".nectar-progress-bar"
          : ht + ".nectar-progress-bar";
    bt.usingMobileBrowser && "bottom-in-view" == e && (e = "70%"),
      t(a).each(function () {
        var a = t(this),
          n = new Waypoint({
            element: a[0],
            handler: function () {
              if (
                ...
                new oe(s, 0, i, 0, 1, { useEasing: !1 }).start(),
                  a
                    .find("span strong")
  ...
  function ta() {
    var e = 1 == ut ? "500%" : "75%";
    t(ht + '.wpb_column[data-border-animation="true"]').each(function () {
      var a = t(this),
        n = new Waypoint({
          element: a[0],
          handler: function () {
  ...
  function ea() {
    t(ht + ".nectar-waypoint-el").each(function () {
      var e =
          ...
          if (bt.winW > 690) {
            ...
            t(this).parents(".nectar_image_with_hotspots").width() - 200
              ...
              e.left < 0
                ...
                : e.left + t(this).find(".nttip").outerWidth(!0) > bt.winW
                ? t(this)
                    .find(".nttip")
                    .addClass("force-left")
                    .css("width", "250px")
  ...
  function ra() {
    var e = 1 == ut ? "500%" : "50%";
    t(ht + '.nectar_image_with_hotspots[data-animation="true"]').each(
      function () {
        var a = t(this),
          n = new Waypoint({
            element: a[0],
    ...
    if (a.classList.contains("nectar-lazy")) {
      a.addEventListener("load", function () {
        a.classList.contains("keep-calculated-size") ||
          ...
          bt.usingMobileBrowser || Waypoint.refreshAll(),
          i.unobserve(a);
      }),
        (a.src = n);
  ...
  function ca() {
    ...
    if ("IntersectionObserver" in e) {
      s.off("resize.nectarLazySizing", ha),
        s.on("resize.nectarLazySizing", ha),
      ...
      var r = new IntersectionObserver(
          ...
          { root: Xt() ? null : a, rootMargin: "125px" }
        ),
  ...
  function ga() {
    var e = 1 == ut ? "200%" : "75%";
    t(ht + ".nectar-post-grid-wrap").each(function () {
      if (
        !v ||
        !t(this).hasClass("delay-js-loaded") ||
        0 != mt.$usingFullScreenRows
      )
        var a = t(this),
          n = new Waypoint({
  ...
  function ma() {
    var e = 1 == ut ? "500%" : "bottom-in-view";
    t(ht + ".nectar-animated-title").each(function () {
      var a = t(this),
        n = new Waypoint({
          element: a[0],
          handler: function () {
  ...
  function va() {
    var e = 1 == ut ? "500%" : "bottom-in-view";
    bt.usingMobileBrowser && "bottom-in-view" == e && (e = "85%"),
      t(ht + ".nectar-highlighted-text").each(function (a) {
        var n = 0;
        if (
          (t(this)
            .find("i")
  ...
  function ba() {
    var e = 1 == ut ? "500%" : "75%";
    t(ht + '.nectar-woo-flickity[data-animation*="fade-in"]').each(function () {
      var a = t(this),
        n = new Waypoint({
          element: a[0],
          handler: function () {
        ...
        ? t(".testimonial_slider").each(function (e) {
            var a = t(this),
              n = t(this).is("[data-style]")
                ...
                : "none";
            (tt[e] = new NectarTestimonialSlider(a, n, za, Ve)),
              t(this).is(
                '.disable-height-animation:not([data-style*="multiple_visible"])'
              ) &&
                (tt[e].testimonialSliderHeight(),
                setTimeout(tt[e].testimonialSliderHeight.bind(tt[e]), 700)),
              t(this).is(
                '.testimonial_slider[data-style="multiple_visible_minimal"]'
              ) && tt[e].testimonialSliderHeightMinimalMult();
          })
        : Ut("#nectar-testimonial-sliders-js", 0, ya);
  }
  function _a() {
    s.off("smartresize.nectarTestimonials"),
      s.off("resize.nectarTestimonialsMin"),
      tt.length > 0 && s.on("smartresize.nectarTestimonials", Ca),
      t('.testimonial_slider[data-style="multiple_visible_minimal"]').length >
        0 && s.on("resize.nectarTestimonialsMin", xa);
  }
  function Ca() {
    for (var t = 0; t < tt.length; t++)
      tt[t].testimonialSliderHeight(), tt[t].testimonialHeightResize();
  }
  function xa() {
    for (var t = 0; t < tt.length; t++)
      tt[t].testimonialSliderHeightMinimalMult();
  }
  function ka(e) {
  ...
  function Ma() {
    ...
    t("#slide-out-widget-area > .widget").each(function () {
      ...
      t("#slide-out-widget-area .inner")
        .first()
        .css({ height: "auto", "min-height": e });
  }
  function Wa() {
  ...
  function Ba() {
    t(".ocm-effect-wrap.material-ocm-open").length > 0 &&
      ...
      t(".ocm-effect-wrap-inner").css({ "padding-top": bt.adminBarHeight }));
  }
  function Fa() {
    t(
  ...
  function qa() {
    ...
    t(".ocm-effect-wrap-inner > #boxed").length > 0
      ? (t(
        ...
        ).appendTo("#slide-out-widget-area .inner-wrap > .inner"),
        t(
  ...
  function Pa() {
    ...
    (bt.usingMobileBrowser ||
      ...
      La(),
      t(".slide-out-from-right-hover.ios-ocm-style").length > 0 &&
        (t("#ajax-content-wrap").addClass("ios-ocm-style-open"),
        setTimeout(function () {
    ...
    if (
      ...
      if (
        ...
        t(".left-aligned-ocm").length > 0 &&
        "none" != t(".left-aligned-ocm").css("display")
          ? c.css({
              top:
                t(
                  "header#top .left-aligned-ocm .slide-out-widget-area-toggle a"
                ).offset().top - bt.scrollTop,
            })
          : c.css({
              top:
                t(
        ...
        t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0
          ? ((i =
            ...
            c.css({
              top: parseInt(i.top) - bt.scrollTop,
              right:
                parseInt(
                  t("#header-outer header >.container").css("padding-right")
                ) + 2,
          ...
          : ((i = r.hasClass("ascend")
            ...
            c.css({
              top: bt.adminBarHeight + h + parseInt(i.top),
              right:
                parseInt(
                  t("#header-outer header >.container").css("padding-right")
                ) + 2,
    ...
    if (
      ...
      0 == t('#header-outer[data-permanent-transparent="1"]').length &&
        ...
        !bt.usingFrontEndEditor &&
        bt.winW > 1e3 &&
        ((0 == bt.scrollTop && t("#header-outer.transparent").length > 0) ||
          (0 == t("body.mobile").length &&
            pt &&
            (d
        ...
        0 == t('#header-outer[data-remove-fixed="1"]').length &&
          ...
          pt &&
          (1 == k
            ? (s.off("scroll", _n), s.off("scroll", yn))
            : (s.off("scroll", Cn), s.off("scroll", xn)))),
      bt.usingMobileBrowser)
    )
      return !1;
    s.on("mousemove.rightOffsetCheck", ja);
  }
  function ja(a) {
    var n = s.width(),
      i = o.outerWidth(),
    ...
    ("left" !==
      ...
      s.off("mousemove.rightOffsetCheck", ja),
        ...
        0 == t('#header-outer[data-remove-fixed="1"]').length &&
          ...
          (1 == k
            ? (s.off("scroll.headerResizeEffect"),
              0 == bt.scrollTop
                ? (s.on("scroll.headerResizeEffect", yn),
                  t(
                ...
                : s.on("scroll.headerResizeEffect", _n))
  ...
  function Ya() {
    ...
    (bt.usingMobileBrowser ||
      ...
      t(".slide-out-from-right-hover.ios-ocm-style").length > 0 &&
        (t("#ajax-content-wrap").removeClass("ios-ocm-style-open"),
        t("#slide-out-widget-area .slide_out_area_close").removeClass(
          "material-ocm-open"
        )),
      o.css({ transform: "" }).removeClass("open"),
  ...
  function Na() {
    function a() {
      ...
      return (
        ...
        t(this).hasClass("simple-mobile-menu")
          ? (Va("simple-mobile-menu"), t(this).find("a").addClass("open"), !1)
          : (o.hasClass("slide-out-from-right")
                    ...
                    t("body.material").length > 0 &&
                      ...
                      t(
                        ...
                        (t("#header-outer:not(.fixed-menu)").css(
                          "top",
                          bt.adminBarHeight - bt.scrollTop + "px"
                        ),
                        c.length > 0 &&
                      ...
                      t(
                        ...
                        transition: "none",
                        transform: "translateY(" + bt.adminBarHeight + "px)",
                      }),
                      setTimeout(function () {
              ...
              ? (function () {
                  ...
                  var e = 0,
                    a = 0;
                  bt.scrollTop + s.height() > t(".blurred-wrap").height() &&
                    0 == t("#nectar_fullscreen_rows").length &&
                    (t("body,html")
                      .stop()
                      .animate(
                    ...
                    t("#slide-out-widget-area.fullscreen")
                      .show()
                      .addClass("open"),
                    0 == t(".nectar-social.fixed").length && Kn(),
                  ...
                  var n =
                    d.offset().top - bt.scrollTop + bt.secondaryHeaderHeight;
              ...
              : t("#header-outer #mobile-menu").length > 0 &&
                ((a = 150), Va("slide-out-widget-area-toggle")),
            (yt.ocmAnimating = !0),
            setTimeout(function () {
              yt.ocmAnimating = !1;
            }, a),
    ...
    if (
      ...
      r.on(
        "click",
        ".slide-out-widget-area-toggle:not(.std-menu) a.open:not(.animating), .nectar-ocm-trigger-open a.open, #slide-out-widget-area .slide_out_area_close, > .slide_out_area_close, #slide-out-widget-area-bg.slide-out-from-right, .material-ocm-open #ajax-content-wrap, #ajax-content-wrap.ios-ocm-style-open",
        function (a) {
          var n;
          if (
            ...
            return (
              ...
              t(this).parents(".simple-mobile-menu").length > 0
                ? (Xa("simple-mobile-menu"), t(this).removeClass("open"), !1)
                : (t(
                  ...
                  o.hasClass("slide-out-from-right")
                    ...
                    ? (t("body.material").length > 0 &&
                      ...
                      setTimeout(function () {
                        0 == t(".nectar-social.fixed").length && Jn(),
                    ...
                    : t("#header-outer #mobile-menu").length > 0 &&
                      Xa("slide-out-widget-area-toggle"),
                  0 == t("#header-outer #mobile-menu").length &&
      ...
      t(".nectar-ocm-image." + i).length > 0 &&
        ...
        t(".off-canvas-menu-container .menu > .menu-item-has-children > a").on(
          "click",
          function (e) {
            var a = Da(t(this).parent().attr("class"));
  ...
  function Qa() {
    ((W && r.hasClass("material") && o.hasClass("slide-out-from-right")) ||
      (e.nectarOptions &&
      ...
      W &&
        t("body").on(
          "click",
          "#ajax-content-wrap.ios-ocm-style-open",
          function () {
            t(".slide-out-widget-area-toggle a").trigger("click");
          }
        ),
        ...
        ? (function () {
            ...
            if (
              ...
              r.on(
                ...
                r.on("click", "#slide-out-widget-area-bg", Ra),
                r.on(
                  "click",
          ...
          0 != t("#header-outer #mobile-menu").length &&
            ...
            t("#header-outer #mobile-menu ul li").each(function () {
              (t(this).find("> ul").length > 0 ||
                t(this).find("> .nectar-global-section-megamenu").length > 0) &&
                t(this)
                  .find("> a")
                  .append(
              ...
              function () {
                ...
                return (
                  ...
                  e.hasClass("current-open-item")
                    ? (e.find("> ul, > .nectar-global-section-megamenu").show(),
                      setTimeout(function () {
                        e.addClass("visible");
                      }, 30))
                    : (e.find("ul, .nectar-global-section-megamenu").hide(),
                      e
                        .find("li")
                        .removeClass("visible")
      ...
      0 ==
        ...
        : t(
          ...
          t(
            ...
            "#" != t(this).attr("href") && Za(t(this).parent());
          }),
      t("#nectar_fullscreen_rows").length > 0 &&
  ...
  (pe.prototype.setup = function () {
    ...
    (pe.prototype.viewportTracking = function () {
      var t = this;
      if ("IntersectionObserver" in e) {
        (this.observer = new IntersectionObserver(
          function (e) {
    ...
    (pe.prototype.calcWidth = function () {
      var t = this,
    ...
    (pe.prototype.sequence = function () {
      if (
    ...
    (pe.prototype.staggerWaypoint = function () {
      var e = this;
      if (1 == ut && 0 == this.$el.parents(".active").length) return !0;
    ...
    (ve.prototype.setVertCenter = function () {
      var t = (bt.winH - this.$el.find(".scrolling-tab-nav").height()) / 2;
      a.documentElement.style.setProperty(
        "--nectar-sticky-tabs-vert-y",
        t + "px"
      );
    }),
    (ve.prototype.updateActiveTitle = function () {
      var t = this.$el.find(
    ...
    (ve.prototype.domSetup = function () {
      var e = this,
        a = "";
    ...
    (ve.prototype.highlightObserve = function () {
      var n = this;
      if (
        !(bt.usingMobileBrowser && bt.winW < 1e3) &&
        "IntersectionObserver" in e
      ) {
        var i = d.is('[data-remove-fixed="1"]')
            ? "100px 0px 0px 0px"
            : "5px 0px 0px 0px",
          s = { root: Xt() ? null : a, rootMargin: i, threshold: 1 };
    ...
    (ve.prototype.lineAnimation = function () {
    ...
    (_e.prototype.lazyInit = function () {
      var t = this;
      if (!bt.usingFrontEndEditor && "IntersectionObserver" in e) {
        t = this;
    ...
    (_e.prototype.calcTopOffset = function () {
      this.topOffset = (bt.winH - this.$innerEl.height()) / 2;
    }),
    (_e.prototype.resizeEvent = function () {
      bt.winW > 1e3
        ? (this.calcTopOffset(), this.$innerEl.css({ top: this.topOffset }))
        : this.$innerEl.css({ top: "" });
    }),
    (We.prototype.setType = function () {
    ...
    (We.prototype.calculatePos = function () {
      1 != yt.materialOffCanvasOpen &&
        1 != yt.ocmAnimating &&
        ((this.offsetTop = this.$element.offset().top),
        (this.height = this.$element.outerHeight()),
        (this.vertCenter = this.storedWinH / 2 - this.height / 2)),
        bt.usingMobileBrowser || (this.storedWinH = bt.winH);
    }),
    (We.prototype.orientationChange = function () {
      bt.usingMobileBrowser &&
        ((this.offsetTop = this.$element.offset().top),
        (this.height = this.$element.outerHeight()),
        (this.storedWinH = bt.winH));
    }),
    (We.prototype.trackView = function () {
      var t = this;
      if (
        (this.$element.parents(".top-level").length > 0 &&
          ((this.topLevel = !0),
          this.offsetTop > bt.winH && (this.topLevel = !1)),
        this.$element.is(".nectar_hook_global_section_parallax_footer") &&
          (this.bottomLevel = !0),
        "IntersectionObserver" in e)
      ) {
        var n = { root: Xt() ? null : a, rootMargin: "250px" };
    ...
    (We.prototype.animate = function () {
      if (1 != yt.materialOffCanvasOpen) {
        if (
          (1 == this.lerp
            ? (this.lastY = bt.scrollTop)
            : (this.lastY = parseInt(Dt(this.lastY, bt.scrollTop, this.lerp))),
          1 == yt.animatedScrolling && (this.inView = !0),
          this.inView)
        ) {
          var t = this.intensity;
          bt.winW < 1025 && (t /= 1.2),
            bt.winW < 690 && (t /= 1.35),
            (!0 === this.topLevel && bt.winW > 1e3) ||
            (!0 === this.topLevel && this.persistOnMobile)
              ? (this.$elementInner[0].style.transform =
                  this.type + "(" + -this.lastY * t + "px) translateZ(0)")
              : (!0 === this.bottomLevel && bt.winW > 1e3) ||
                (!0 === this.bottomLevel && this.persistOnMobile)
              ? (this.$elementInner[0].style.transform =
                  this.type +
                  "(" +
                  -(this.lastY - (this.offsetTop + this.height) + bt.winH) * t +
                  "px) translateZ(0)")
              : bt.winW > 1e3 || this.persistOnMobile
              ? (this.$elementInner[0].style.transform =
                  this.type +
                  "(" +
    ...
    (Be.prototype.orientationChange = function () {
      bt.usingMobileBrowser &&
        ((this.offsetTop = this.$el.offset().top),
        (this.height = this.$el.outerHeight(!0)),
        (this.storedWinH = bt.winH));
    ...
    (Be.prototype.update = function () {
      if (
        this.offsetTop + 150 + this.height < bt.scrollTop ||
        this.offsetTop - 150 > bt.scrollTop + this.storedWinH ||
        1 == yt.materialOffCanvasOpen
      ) {
        ...
        for (t = 0; t < this.$parallaxEl.length; t++)
          !0 === this.firstSection
            ? (this.$parallaxEl[t].style.transform =
                "translate3d(0, " + bt.scrollTop * this.speed + "px, 0)")
            : (this.$parallaxEl[t].style.transform =
                "translate3d(0, " +
                (this.storedWinH + bt.scrollTop - this.offsetTop) * this.speed +
                "px, 0) scale(1.005)"),
            (this.$parallaxEl[t].style.willChange = "transform");
        requestAnimationFrame(this.update.bind(this));
      }
    }),
    t(e).on("salient-parallax-el-recalculate", Fe),
    (Le.prototype.setupProps = function () {
      var t = JSON.parse(
    ...
    (Le.prototype.lazyInit = function () {
      var t = this;
      if (
        !bt.usingFrontEndEditor &&
        "IntersectionObserver" in e &&
    ...
    (Le.prototype.setActiveDevice = function () {
      var t = this;
      Object.keys(this.devices).forEach(function (e) {
        bt.winW >= t.devices[e].min &&
          bt.winW <= t.devices[e].max &&
          ((t.activeDevice = e),
          void 0 !== t.timelines[e] && t.timelines[e].reset());
      });
    }),
    (Le.prototype.createTimeline = function () {
      var t = this;
      Object.keys(this.devices).forEach(function (e) {
    ...
    (Le.prototype.progressValues = function () {
    ...
    t(e).on("salient-parallax-bg-recalculate", Ye),
    (Ge.prototype.calculatePos = function () {
      1 != yt.materialOffCanvasOpen &&
        1 != yt.ocmAnimating &&
        ((this.offsetTop = this.$element.offset().top),
        (this.height = this.$element.outerHeight()),
        (this.vertCenter = bt.winH / 2 - this.height / 2));
    }),
    (Ge.prototype.trackView = function () {
      var t = this;
      if (
    ...
    (Ge.prototype.animate = function () {
      if (1 != yt.materialOffCanvasOpen) {
        if (
          (1 == yt.animatedScrolling && (this.inView = !0),
          (this.lastY = Dt(this.lastY, bt.scrollTop, 0.2)),
          this.inView)
        ) {
          var a = this;
    ...
    (Je.prototype.mergeNeighbors = function () {
      var t = this.$el.closest(".wpb_row");
      t.length > 0 &&
        t.find(
    ...
    (Je.prototype.trackInView = function () {
      var t = this;
      new IntersectionObserver(
        function (e) {
          e.forEach(function (e) {
      ...
      e.top + bt.scrollTop + e.height < bt.winH && (this.topLevel = !0);
    }),
    (Je.prototype.events = function () {
      bt.usingMobileBrowser
        ? e.addEventListener("orientationchange", this.calc.bind(this))
        : e.addEventListener("resize", this.calc.bind(this)),
        this.calc();
    }),
    (Je.prototype.calc = function () {
      (this.offsetTop = this.$el.offset().top),
        (this.elHeight = this.$el.outerHeight()),
        (this.wordCount = this.mergedGroup
          ? this.$el.find(".nectar-split-heading .inner").length
          : this.$el.find(".inner").length),
        this.elHeight / bt.winH < 0.25 && this.wordCount < 40
          ? (this.speed = 2.5)
          : ((this.speed = Math.max(
              2 - Math.min(this.elHeight / bt.winH, 1.45),
              0.66
            )),
            (this.speed < 1.2 || (this.wordCount < 30 && this.speed < 1.5)) &&
              ((this.topCushion = 0.25 * bt.winH), (this.wordDelay = 250)));
      var t = this.$el
        .find('.nectar-split-heading[data-text-effect="scroll-opacity-reveal"]')
        .attr("data-animation-offset");
      t &&
        parseInt(t) > 0 &&
        parseInt(t) < 100 &&
        ((t = parseInt(t)),
        (this.topCushion =
          0.05 * bt.winH + 0.05 * bt.winH * (1 - t / 100) * 6));
    }),
    (Je.prototype.createTimeline = function () {
      var t = this;
    ...
    (Je.prototype.raf = function () {
      var t;
      this.inView && 1 != yt.materialOffCanvasOpen
        ? ((t = this.topLevel
            ? (bt.scrollTop / bt.winH) * 1.5
            : 1 +
              (bt.scrollTop - (this.offsetTop + this.topCushion)) / bt.winH),
          this.timeline.seek(t * this.timeline.duration * this.speed),
          requestAnimationFrame(this.raf.bind(this)))
        : requestAnimationFrame(this.raf.bind(this));
    }),
    t(e).on("salient-lazyloading-image-reinit", ca),
    t(e).on("salient-lazyloading-image-reinit", ha),
    (fa.prototype.initialMarkup = function () {
      if (
        ...
        if (
          (this.el.find(".nectar-post-grid-filters .active").length > 0 &&
            (this.activeFilter =
              this.el.find(".nectar-post-grid-filters .active").index() + 1),
          "yes" === this.sortable ||
          ...
          this.el.find(".nectar-post-grid-filters a").each(function () {
            e += parseInt(t(this).attr("data-total-count"));
          }),
            (this.activeCatTotal = e);
        }
    ...
    (fa.prototype.lightboxGroups = function () {
      var e = te(),
    ...
    (fa.prototype.externalProjectLinks = function () {
      this.el.hasClass("target-blank-external-urls") &&
        ...
        this.el
          ...
          .attr("target", "_blank")
          .attr("rel", "nofollow")),
        this.el.hasClass("target-blank-all-urls") &&
          (this.el
            .find(".nectar-post-grid-item a[href*='http://']")
            .attr("target", "_blank"),
          this.el
            .find(".nectar-post-grid-item a[href*='https://']")
            .attr("target", "_blank"));
    }),
    (fa.prototype.clickEvents = function () {
        ...
        .on("click", function (r) {
          ...
          var f = {
            ...
            settings: {
              ...
              heading_tag_render: a.heading_tag_render,
              ...
              custom_fields_location: a.custom_fields_location,
              display_type: a.display_type,
              text_content_layout: a.text_content_layout,
            },
          };
          "rand" == n.orderby &&
            "load-more" == c &&
                  ...
                  l
                    ...
                    .each(function (e) {
                      t(this).find(".nectar-split-heading").length > 0 &&
                        qn(t(this).find(".nectar-split-heading"));
                      var n = t(this);
                      setTimeout(function () {
                        n.addClass("animated-in"),
    ...
    (fa.prototype.deepLinking = function () {
      void 0 !== re["grid-filter"] &&
        this.el.find(".nectar-post-grid-filters a").each(function () {
          var e = t(this).clone(),
            a = re["grid-filter"];
          t(this);
      ...
      _initEvents: function () {
        ...
        this.$trigger.on("click.menu", function () {
          ...
          this.$menuitems.on("click.menu", function (a) {
            ...
            e.options.onLinkClick(n.find("> a"), a), Za(n);
          }),
          this.$back.on("click.menu", function () {
            var a = t(this),
              n = a.parents(".sub-menu:first"),
              i = n.parent(),
  ...
  function tn() {
      ...
      var r = new Image(),
        ...
        d =
          t(".nectar-global-section.after-nav").length > 0
            ...
            : 0,
        c = ne(t('#page-header-bg[data-parallax="1"]').css("background-image"));
      c && -1 !== c.indexOf(".")
        ? ((r.onload = function () {
            Ka();
          }),
        ...
        e.addEventListener(
          "scroll",
          function () {
            bt.winW > 1e3 && e.requestAnimationFrame(p);
          },
          !1
        );
    }
    ...
    if (g.length > 0) {
      ...
      var u = ne(g.css("background-image"));
    ...
    function p() {
      bt.winW >= 1e3 &&
        ...
        (1 == a.inView &&
          (n.css({
            transform: "translateY(" + 0.15 * bt.scrollTop + "px)",
            opacity: 1 - bt.scrollTop / (0.7 * (d + o)),
          }),
          i &&
            i.css({
              transform: "translateY(" + 0.15 * bt.scrollTop * 2 + "px)",
            })),
        bt.scrollTop / (o + l + bt.adminBarHeight) > 1
          ? ((a.inView = !1),
  ...
  function sn() {
    t(".nectar-box-roll").length > 0 &&
      ...
      ((gt = new NectarBoxRoll(bt, rn, nn, ai, za)).inUse = !0));
  }
  function rn() {
    ...
    (a = 1 == ut ? "500%" : "93%"),
      ...
      t(
        ...
        o =
          "zoom-out-reveal" != e && -1 == e.indexOf("reveal-from-")
            ? l
            : "ro-reveal-from-bottom" == e && 0 == ut
            ? "95%"
            : "ro-reveal-from-top" == e && 0 == ut
            ? "65%"
            : c;
        var a = t(this),
          n = new Waypoint({
      ...
      t(ht + ".column-bg-overlay-wrap[data-bg-animation]").each(function () {
        o = c;
        var e = t(this),
      ...
      na(),
      (h = 1 == ut ? "250%" : "75%"),
      t(ht + '.nectar-icon-list[data-animate="true"]').each(function () {
        var e = t(this),
          a = new Waypoint({
            element: e[0],
            handler: function () {
      ...
      ra(),
      (u = 1 == ut ? "200%" : "95%"),
      t(ht + ".clients.fade-in-animation").each(function () {
        var e = t(this),
          a = new Waypoint({
            element: e[0],
            handler: function () {
      ...
      Ue(),
      (p = 1 == ut ? "500%" : "bottom-in-view"),
      0 == q.length ||
      (bt.usingFrontEndEditor && t("#nectar_fullscreen_rows").length > 0)
            ...
            .each(function (e) {
              ...
              if (
                ("false" == a.attr("data-animation") &&
                  ((n = 1), a.css("opacity", "1")),
                a.hasClass("bound") ||
                  (q[e] = new Vivus(a.find("svg").attr("id"), {
                    type: "delayed",
              ...
              function s() {
                ...
                1 == q[e].isReady
                  ? setTimeout(function () {
                      a.css("opacity", "1"), q[e].reset().play();
                    }, t)
                  : setTimeout(s, 50);
              }
              a.addClass("bound");
      ...
      (function () {
        if (
          ...
          var e = "";
          t(ht + ".nectar-milestone.motion_blur").each(function (a) {
            t(this).removeClass(function (t, e) {
              return (e.match(/(^|\s)instance-\S+/g) || []).join(" ");
            }),
              t(this).addClass("instance-" + a);
            ...
            if (
              ...
              var u = t(this).find(".number").text().split(""),
                p =
                  t(this).find(".milestone-heading").length > 0
                    ? t(this).find(".milestone-heading")
                    : t(this).find(".number");
              p.empty(),
      ...
      Oe(),
      t(ht + '.owl-carousel[data-enable-animation="true"]').each(function () {
        var e = 1 == ut ? "200%" : "bottom-in-view",
          a = 0;
        t(this).is("[data-animation-delay]") &&
          t(this).attr("data-animation-delay").length > 0 &&
          "false" != t(this).attr("data-animation") &&
      ...
      (function () {
        if (
          ...
          var e = w / 2 + y + bt.adminBarHeight;
          0 == t('#header-outer[data-permanent-transparent="1"]').length &&
            (e = w - _ + Math.ceil((2 * y) / 1.8) + bt.adminBarHeight),
            t(
    ...
    kt(),
      ...
      r.on("click", ".toggle > h3 a, .toggle > .toggle-title a", function () {
        if (!t(this).parents(".toggles").hasClass("accordion")) {
          ...
          if (
            ...
            for (var n = 1; n < 10; n++) setTimeout(we, 100 * n);
          return (
            setTimeout(function () {
        ...
        function (a) {
          ...
          if (0 == t(this).parents('.toggle[data-inner-wrap="true"]').length)
            ...
            void 0 !== a.originalEvent &&
              ...
              (i.find(".toggle.open"),
              setTimeout(function () {
                var e = r.offset().top - bt.adminBarHeight;
                t('#header-outer[data-mobile-fixed="1"]').length > 0 &&
                  (e = r.offset().top - d.outerHeight() - bt.adminBarHeight),
                  ee(e, 0, "easeInOutQuint");
              }, 50));
            var o = r.find("> div")[0];
            i.find(".toggle > div").each(function () {
              t(this)[0].style.maxHeight = null;
      ...
      0 !== t(".team-member").length &&
              ...
              if (
                ((c = t(this).is('[data-style="bio_fullscreen_alt"]')
                  ...
                  : "<h2>" +
                    ...
                    "</div>"),
                r.append(
                  '<div class="nectar_team_member_overlay nectar-modal ' +
                    a +
                    '" data-style="' +
                    l +
        ...
        (t('.team-member[data-style="bio_fullscreen"]').length > 0 ||
          ...
          (s.on("resize", Te), !bt.usingMobileBrowser)) &&
        new $t("", "close-indicator"),
      ...
      t(".morphing-outline").length > 0 &&
        (setTimeout(Ee, 100), setTimeout(Ve, 125), s.on("smartresize", Ee)),
      (V = []),
      bt.usingMobileBrowser ||
        t("[data-nectar-link-indicator]").each(function (e) {
          t(this).is("[data-indicator-text]")
            ? (V[e] = new $t(t(this), "view-indicator"))
            : (V[e] = new $t(t(this), "link-indicator"));
        }),
      pa(),
            ...
            s.on("smartresize", function () {
              if (
                ...
                ((f.length > 0 &&
                  ...
                  (f.length > 0 && t('body[data-hhun="1"]').length > 0 && B)) &&
                  (W || (n += f.height())),
              ...
              (i.prototype.createWaypoint = function () {
                      ...
                      handler: t.proxy(function (a) {
                        ...
                        if ((this.$wrapper.height(r), i)) {
                          ...
                          if (
                            ...
                            var l = d.outerHeight(),
                              h = 0;
                            c.length > 0 && (l -= bt.secondaryHeaderHeight),
                              f.length > 0 &&
                                0 == t("body.mobile").length &&
                                (h = pt ? f.height() : 0),
                              (o = l - h);
                ...
                setInterval(function () {
                  if (
                    ...
                    var e = d.outerHeight();
                    c.length > 0 && (e -= bt.secondaryHeaderHeight),
  ...
  function hn() {
    ...
    if (
      ...
      !(
        t('.products[data-rm-m-hover="1"]').length > 0 && bt.usingMobileBrowser
      ) &&
        (r.on(
          "mouseover",
    ...
    if (
      ...
      new ln();
    t(a).on("yith-wcan-ajax-filtered", ca);
  }
  function un() {
    return (
    ...
    t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 &&
      (function () {
        var e = d,
          ...
          u = o + h + l + parseInt(bt.secondaryHeaderHeight);
        function p() {
          ae()
        ...
        function g() {
          if (
            ...
            if (
              ((f =
                f.length > 0 && bt.secondaryHeaderHeight > 0 ? f.height() : 0),
              e.hasClass("force-condense") ||
                (!e.hasClass("fixed-menu") && bt.scrollTop >= u))
            ) {
              var n =
                parseInt(a.position().top) -
                o -
                parseInt(bt.adminBarHeight) +
                parseInt(bt.secondaryHeaderHeight) -
                f;
              if (
        ...
        i.length > 0 &&
          ...
          setTimeout(function () {
            "none" != c.css("display") &&
              (bt.secondaryHeaderHeight = c.outerHeight());
          }, 50),
          t('#header-outer[data-condense="true"]').length > 0 &&
  ...
  function vn() {
    t("#nectar_fullscreen_rows").length > 0 &&
      ...
      0 == t(".nectar-box-roll").length
        ? nn()
        : t("#nectar_fullscreen_rows").length > 0 && 0 == ut && nn();
  }
  (t.fn.dlmenu = function (e) {
      ...
      this.each(function () {
        ...
        n
          ? t.isFunction(n[e]) && "_" !== e.charAt(0)
            ? n[e].apply(n, a)
            : Ua("no such method '" + e + "' for menu instance")
          : Ua(
    ...
    (ln.prototype.mobileToggleResize = function () {
    ...
    (ln.prototype.mobileToggle = function () {
      return (
        this.$sidebar.hasClass("open")
          ? (this.$sidebar.removeClass("open"),
            this.$sidebar.find(".nectar-close-btn-wrap").removeClass("open"),
    ...
    (ln.prototype.toggle = function () {
      if (bt.winW < 1e3) return this.mobileToggle(), !1;
      var a = "";
      return (
    ...
    (ln.prototype.getLS = function () {
      return "undefined" != typeof Storage
        ? localStorage.getItem("nectar_product_filters_vis")
        : null;
    }),
    (dn.prototype.updateState = function (t) {
      var e = 0;
    ...
    (dn.prototype.setStep = function () {
      if (this.$qty.is("[step]")) {
        var t = parseInt(this.$qty.attr("step"));
        isNaN(t) || "" == t || 0 == t || (this.step = t);
      }
    }),
    (dn.prototype.increment = function () {
      this.state.max &&
    ...
    (dn.prototype.decrement = function () {
      this.state.min &&
    ...
    (dn.prototype.checkMiniCart = function (t) {
      return t.parents(".woocommerce-mini-cart").length > 0;
    }),
    (dn.prototype.updateQuantityCallback = function (n, i) {
    ...
    (dn.prototype.updateCart = function (a) {
      var n = this;
    ...
    (cn.prototype.addNotices = function (e) {
      var a = t(
    ...
    (cn.prototype.addToCartAJAX = function (a) {
      var n = this,
    ...
    (pn.prototype.resetHeight = function () {
      this.$parent.css({ "max-height": "" }),
        setTimeout(function () {
    ...
    (pn.prototype.requestCheck = function () {
      !0 === this.state.requesting &&
        (this.request.abort(), (this.state.requesting = !1));
    }),
    (pn.prototype.getResults = function () {
      var a = this,
        n = this.$el.val();
  ...
  function wn() {
    ...
    (bn.bodyOffsetHeight = a.body.offsetHeight),
      0 == bn.init &&
        setInterval(function () {
          1 != yt.materialOffCanvasOpen &&
            (bn.bodyOffsetHeight = a.body.offsetHeight);
        }, 1500),
      (bn.raf = requestAnimationFrame(function a() {
        d[0].classList.add("detached");
        var o = bt.scrollTop,
          l = Math.abs(o - e);
        if (
          1 == yt.animatedScrolling ||
          1 == yt.preventScroll ||
          1 == yt.ocmOpen
        )
          return (
            o > n &&
              (1 == yt.animatedScrolling &&
                1 == $ &&
                0 == yt.permanentTransHeader &&
                d.removeClass("transparent").addClass("scrolling"),
              (e = bt.scrollTop),
              (o = bt.scrollTop)),
            void (bn.raf = requestAnimationFrame(a))
          );
        if (1 == yt.materialOffCanvasOpen || 1 == yt.materialSearchOpen)
          return (
            1 == yt.materialSearchOpen &&
              1 == $ &&
              (0 == yt.permanentTransHeader && o > n
                ? d.removeClass("transparent").addClass("scrolling")
        ...
        if (
            ...
            (c.length > 0 &&
              (o > n
                ? (c.addClass("hide-up"),
                  d.css(
                    "transform",
                    "translateY(-" + bt.secondaryHeaderHeight + "px)"
                  ))
              ...
              l >= s &&
                (o > e
                  ...
                  : (d.hasClass("invisible") && d.removeClass("invisible"),
                    1 == r &&
                      ((h = d.outerHeight()),
                      c.length > 0 && (h -= bt.secondaryHeaderHeight),
                      f.length > 0 && bt.winW > 999
                        ? ((i = pt ? f.height() : 0),
                          t(".page-submenu.stuck")
          ...
          bt.winH + bt.scrollTop + 30 >= bn.bodyOffsetHeight &&
        ...
        (e = o), (bn.raf = requestAnimationFrame(a));
      })),
      0 == bn.init && (bn.init = !0);
  }
  function yn() {
    var e = bt.scrollTop,
      a = bt.winW,
      n = 30;
    1 != $ || bt.usingMobileBrowser || (n = M ? 30 : 0),
      e > n &&
        a >= 1e3 &&
        0 == t("body.material-ocm-open").length &&
        (r.is(".material") &&
        ...
        s.off("scroll.headerResizeEffect", yn),
        s.on("scroll.headerResizeEffect", _n),
      ...
      ((e <= n && a >= 1e3) ||
        ...
        t(".nectar-box-roll").length > 0 &&
          ...
          t("#ajax-content-wrap").animate(
            {
              "margin-top": Math.floor(
                w + 2 * y + bt.adminBarHeight + bt.secondaryHeaderHeight
              ),
            },
            { queue: !1, duration: 250, easing: "easeOutCubic" }
          ),
        s.off("scroll.headerResizeEffect", _n),
        s.on("scroll.headerResizeEffect", yn),
        t('#header-outer[data-transparent-header="true"]').css(
          "transition",
          "transform 0.3s ease, background-color 0.30s ease, opacity 0.3s ease, box-shadow 0.30s ease, margin 0.25s ease-out, backdrop-filter 0.25s ease"
  ...
  function Cn() {
    (t(
      ...
      (bt.scrollTop >= 1 &&
        ...
        s.off("scroll.headerResizeEffectOpaque", Cn),
        s.on("scroll.headerResizeEffectOpaque", xn)));
  }
  function xn() {
    (t(
      '#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]'
      ...
      (bt.scrollTop < 1 &&
        ...
        t("body.material").length > 0 &&
          ...
          c.length > 0 &&
            ...
            (c.removeClass("hide-up"),
            d.removeClass("hide-up").css("transform", "translateY(0%)"))),
        s.off("scroll.headerResizeEffectOpaque", xn),
        s.on("scroll.headerResizeEffectOpaque", Cn)));
  }
  function kn() {
    1 != yt.materialOffCanvasOpen
      ? (bt.scrollTop > 5
          ? "scrolled" != yt.mobileHeader &&
            (0 == yt.permanentTransHeader && d.removeClass("transparent"),
            bt.secondaryHeaderHeight > 0
              ? (c.addClass("hide-up"),
                d
                  .css(
                    "transform",
  ...
  function $n() {
    bt.winW > 999 ||
      ...
      s.off("scroll.headerResizeEffect"),
      s.off("scroll.headerResizeEffectOpaque"),
      "1" == I && t('#header-outer[data-mobile-fixed="1"]').length > 0
      ...
      s.on("smartresize.nectarNavScrollEffects", Tn));
  }
  function Tn() {
    bt.winW < 1e3 ||
      (1 == k && "1" != I
        ...
        : "1" == I &&
          (t(".nectar-box-roll").length > 0 && d.addClass("at-top-before-box"),
          0 == t('#header-outer[data-remove-fixed="1"]').length
            ? (cancelAnimationFrame(bn.raf), wn())
            : (cancelAnimationFrame(bn.raf),
              (bn.timeoutQueued = !0),
              "true" == d.attr("data-transparent-header") &&
                0 ==
      ...
      s.off("smartresize.nectarNavScrollEffects"),
      s.on("smartresize.nectarNavScrollEffects", $n));
  }
  function In() {
    if (t(".mobile").length > 0)
      bt.winH < bt.winW && bt.winW > 1e3
  ...
  function En() {
    ...
    function i() {
      if (!r.hasClass("compose-mode")) {
        if (((n = bt.scrollTop), e == n)) return requestAnimationFrame(i), !1;
        (e = n), o(), requestAnimationFrame(i);
      }
    }
    function o() {
      var e = 0;
      if (
        ...
        (e += bt.adminBarHeight) - n > a
          ? d.css("top", e - n + "px")
          : d.css("top", a);
      } else
        0 == C &&
          ((e = 0),
          d.is('[data-remove-fixed="1"]') || (e += bt.adminBarHeight),
          d.css("top", e + "px"));
    }
    function l() {
      var t = 0;
      (t += F), (d[0].style.marginTop = t - n > 0 ? t - n + "px" : "0px");
    }
    t('#header-outer[data-mobile-fixed="1"]').length > 0 &&
      u.length > 0 &&
      (0 == t("#nectar_fullscreen_rows").length
      ...
      W &&
        (0 == t("#nectar_fullscreen_rows").length &&
          requestAnimationFrame(function t() {
            if (r.hasClass("compose-mode")) return;
            if (0 == B && bt.winW < 1e3)
              return requestAnimationFrame(t), d.css("margin-top", "0"), !1;
            n = bt.scrollTop;
            if (a == n) return requestAnimationFrame(t), !1;
            a = n;
            l();
    ...
    if (
      (d.is("[data-logo-height]") && d.is("[data-padding]")
        ? d.hasClass("transparent") ||
          (e =
            "centered-menu-bottom-bar" == d.attr("data-format") && bt.winW > 1e3
              ? d.outerHeight()
              : d.find("#logo.no-image").length > 0
              ? "left-header" == T && bt.winW > 1e3
                ? 0
              ...
              : parseInt(d.attr("data-logo-height")) +
                parseInt(2 * d.attr("data-padding")))
        : (e = "left-header" == T && bt.winW > 1e3 ? 0 : d.outerHeight()),
      ...
      ).css({ "margin-bottom": bt.footerOuterHeight }),
        t(".container-wrap").css({
          "min-height":
            bt.winH - bt.adminBarHeight - e - bt.footerOuterHeight - a + n,
        });
    } else
      t(
        'body[data-footer-reveal="1"]:not(.nectar_using_pfsr) .container-wrap'
  ...
  function Wn() {
    t(".nectar-recent-posts-slider").each(function () {
      ...
      if (bt.winW > 1e3 && 0 == t("#boxed").length)
        0 == t(this).parents(".full-width-content").length
          ? t('body[data-ext-responsive="true"]').length > 0 && bt.winW >= 1400
  ...
  function qn(e) {
    ...
    e.find("> *").each(function () {
      ...
      t(this).attr("aria-label", t(this).text());
    }),
  ...
  function Pn() {
    (t('.nectar-split-heading[data-animation-type="line-reveal-by-space"]')
      ...
      t(
        ...
        if (t(this).is('[data-m-rm-animation="true"]') && bt.winW < 1e3)
          return !0;
  ...
  function jn() {
    if (t(".nectar-recent-posts-slider-inner").length > 0) {
      ...
      a.on("dragStart.flickity", function () {
        ...
        Wn(),
        s.on("resize", Wn),
        bt.usingMobileBrowser || bt.usingFrontEndEditor || s.on("resize", Rn);
    }
                ...
                "none" !=
                  ...
                  (function (t, e) {
                    if (
                      ...
                      P[e].autorotate = setInterval(function () {
                        Zn(t);
                      }, a);
                    }
                  })(
    ...
    t().flickity
      ...
      bt.usingMobileBrowser ||
        (t(".nectar-recent-posts-slider").length > 0 &&
          !bt.usingFrontEndEditor &&
          e.requestAnimationFrame(Yn)),
      bt.usingMobileBrowser || bt.usingFrontEndEditor || Rn();
  }
  function Xn() {
  ...
  function Qn() {
    if (
      ...
      t(".nectar_video_player_self_hosted").each(function (e) {
        !bt.usingMobileBrowser &&
          ...
          (X[e] = new Dn(t(this), ".play_button.follow_mouse .play"));
      }),
      "IntersectionObserver" in e)
    ) {
      var n = new IntersectionObserver(
        ...
        { root: Xt() ? null : a, rootMargin: "-10% 0% -10% 0%", threshold: 0 }
      );
    ...
    t(".nectar-video-box").each(function (e) {
      if (t(this).find(".play_button_mouse_follow").length > 0) {
        ...
        t(this).imagesLoaded(function () {
          bt.usingMobileBrowser ||
            (X[e] = new Dn(a, ".play_button_mouse_follow"));
          var t =
    ...
    (U = []),
      "undefined" != typeof SalientRecentProjectsFullScreen &&
        t(".nectar_fullscreen_zoom_recent_projects").each(function (e) {
          U[e] = new SalientRecentProjectsFullScreen(t(this));
        });
  }
  function Un() {
    t(".infinite_scroll").length > 0 &&
          ...
          t(e)
            ...
            .imagesLoaded(function () {
              ...
              t(".portfolio-filters-inline").length > 0 ||
                ...
                a.isotope({ filter: n }));
              for (var i = 0; i < L.length; i++) L[i].reLayout();
              if (
                (t(e).find(".work-item.style-5").length > 0 && Xn(),
                "none" == t(e).find(".inner-wrap").attr("data-animation"))
              )
                t(".portfolio-items .col .inner-wrap").removeClass("animated");
              else {
                for (i = 0; i < L.length; i++)
                  L[i].masonryZindex(), L[i].portfolioAccentColor();
                t(e).each(function () {
                  var e =
      ...
      t(".post-area.infinite_scroll .posts-container").infinitescroll(
        ...
        function (e) {
          t(e).find("[data-nectar-img-src]").length > 0 && ca(),
              ...
              ? (kt(),
                t().mediaelementplayer &&
                  t(e)
                    ...
                    .mediaelementplayer(),
                he(),
                t(".carousel").length > 0 && (Bt(), Yt()),
                rn(),
                t(".testimonial_slider").animate({ opacity: "1" }, 800),
                ya(),
                _a(),
                setTimeout(function () {
                  Ia(), Ea(), s.trigger("resize");
                }, 500),
                Ye(),
                s.trigger("resize"))
              : (Ye(), s.trigger("resize"));
          ...
          n.imagesLoaded(function () {
            a.parent().hasClass("masonry") &&
              ...
              a.isotope("appended", t(e));
            for (var n = 0; n < at.length; n++) at[n].flickityBlogInit();
            if (
              (t(e).addClass("ajax-loaded"),
              ...
              for (n = 0; n < at.length; n++) at[n].blogMasonryZindex();
              t(e).each(function () {
                var e = t(this),
                  a = new Waypoint({
                    element: e[0],
  ...
  function Kn() {
    if (bt.scrollTop < 350 || o.is(".fullscreen.open")) {
      var e =
  ...
  function ti() {
    if (
      (0 == t(".nectar-social.fixed").length &&
        ((t("#to-top").length > 0 && bt.winW > 1020) ||
          (t("#to-top").length > 0 &&
            t("#to-top.mobile-enabled").length > 0)) &&
        (bt.scrollTop > 350 ? s.on("scroll", Kn) : s.on("scroll", Jn)),
  ...
  function ei() {
    ...
    t('header#top .sf-menu li a[href="#"]').on("click", function (t) {
      ...
      0 == t("#nectar_fullscreen_rows").length || 0 == mt.$usingFullScreenRows
  ...
  function ai() {
    ...
    if (
      ...
      t(".nectar-box-roll").length > 0 &&
        ...
        (gt.boxRoll(null, -1), (u = 2050)),
        t("img[data-nectar-img-src]").length > 0 && (oa(), (u = 200)),
        setTimeout(function () {
          var e;
          if (!0 === E) {
            var n =
            ...
            e = t(a).offset().top - n - bt.adminBarHeight;
            ...
            if (r.hasClass("mobile"))
              ...
              if (
                (t('#header-outer[data-remove-fixed="1"]').length > 0 &&
                  (h = 0),
                (e = l.offset().top - parseInt(h) + s + 3 - bt.adminBarHeight),
                0 == t("body.mobile").length &&
                  t('#header-outer[data-condense="true"]').length > 0 &&
                ...
                e = l.offset().top - parseInt(h) + u - bt.adminBarHeight;
              }
            }
          else e = l.offset().top - bt.adminBarHeight + 1;
          t('body[data-hhun="1"]').length > 0 &&
            0 == t('#header-outer[data-remove-fixed="1"]').length &&
            ...
            (yt.animatedScrolling = !0),
            setTimeout(function () {
              yt.animatedScrolling = !1;
            }, 1100);
        }, u);
    }
  }
  function ni() {
    ...
    t(".portfolio-items:not(.carousel)").each(function (a) {
      if (
        ...
        (L[e] = new SalientPortfolio(t(this), Ve, ht, Ae)), e++;
      else {
        var n = t(this);
        Ut("#salient-portfolio-js-js", 100, function () {
          (L[e] = new SalientPortfolio(n, Ve, ht, Ae)), e++;
        });
      }
    });
  }
      ...
      t(".posts-container").each(function (e) {
        if (
          ...
          if ("undefined" == typeof NectarMasonryBlog) {
            var a = t(this);
            return void Ut("#nectar-masonry-blog-js", 0, function () {
              at[e] = new NectarMasonryBlog(a, Ae, ri);
            });
          }
          at[e] = new NectarMasonryBlog(t(this), Ae, ri);
        } else ri(t(this));
      });
  }
  function li() {
  ...
  function di() {
    var n = li();
    if (!(bt.winW < 690 && bt.usingMobileBrowser)) {
    ...
    if (
      ...
      t().theiaStickySidebar &&
        !(bt.usingMobileBrowser && bt.winW < 1e3) &&
        !(0 != mt.$usingFullScreenRows && bt.winW > 1e3))
    ) {
      var i =
      ...
      e.nectarOptions &&
        ...
        t(i).each(function () {
          if (t(this).parents("#slide-out-widget-area").length > 0) return !0;
          var e = n;
  ...
  function ci() {
    ...
    for (var e = 0; e < K.length; e++)
      "displace-filter-fade" == K[e].animationType &&
        t(K[e].canvasContainer).parents(".fp-section.active").length > 0 &&
        (0 == t(K[e].canvasContainer).find(".image-added-to-stage").length &&
          K[e].imgContainer.addChild(K[e].bg),
        t(K[e].canvasContainer)
          .find(".nectar-liquid-bg")
          .addClass("image-added-to-stage"),
        K[e].animateProps(K[e]));
  }
  function hi() {
    if (t("#nectar_fullscreen_rows").length > 0 && t().fullpage) {
      ht = e.vc_iframe ? ".vc_element.vc_vc_row.active " : ".wpb_row.active ";
      var a =
        t("#nectar_fullscreen_rows[data-mobile-disable]").length > 0
          ? t("#nectar_fullscreen_rows").attr("data-mobile-disable")
          : "off";
      bt.usingMobileBrowser || (a = "off"),
        "on" != a ? (ut = !0) : (ht = ""),
        "undefined" != typeof NectarFullScreenRows &&
          (mt = new NectarFullScreenRows(rn, et, ci, bt, ia, nt, q, it));
    } else Ut("#nectar-fullpage-js", 100, hi);
  }
  function ui() {
    t(".wpb_column").each(function () {
      ...
      bt.usingMobileBrowser && r.addClass("using-mobile-browser"),
      bt.usingTouchDevice && r.addClass("using-touch-device"),
  ...
  function gi() {
    t('body[data-fancy-form-rcs="1"]').length > 0 &&
        ...
        t(this).parents(".wpcf7-form-control-wrap").length > 0
          ...
          : ((e =
            ...
            0 == t(this).parents("#buddypress").length &&
              ...
              0 ==
                t(this).parents(".wc-blocks-components-select__container")
                  .length &&
      ...
      t(
        "select:not(.state_select):not(.country_select):not(.comment-form-rating #rating):not(#tribe-bar-form select):not(.woocommerce-currency-switcher):not(.wc-blocks-components-select__container select):not(.nectar-custom-product-attr select):not(.flatpickr-calendar select)"
      ).each(function () {
        var a = bt.winW > 690 ? 7 : 200;
        if (
  ...
  function wi() {
    setTimeout(function () {
      t("body.compose-mode").length > 0 &&
        ...
        bt.usingFrontEndEditor &&
          (vi(),
          r.is('[data-flex-cols="true"]') || (bi(), s.on("smartresize", bi)));
    }, 200),
      s.on("vc_reload", function () {
        if (
          ...
          for (var a = 0; a < j.length; a++)
            j[a].instance.reloadCells(),
              j[a].instance.off("scroll.flickity"),
              j[a].instance.off("dragStart.flickity"),
              j[a].instance.off("dragEnd.flickity");
        if (
          (It(),
          setTimeout(function () {
            if ((Et(), j.length > 0))
              for (var t = 0; t < j.length; t++)
                j[t].instance.reloadCells(), j[t].instance.resize();
          }, 100),
          J.length > 0)
        )
          for (a = 0; a < J.length; a++)
            J[a].instance.flickity("reloadCells"),
              J[a].instance.off("scroll.flickity"),
              J[a].instance.off("dragStart.flickity"),
              J[a].instance.off("dragEnd.flickity");
        setTimeout(function () {
          if ((t(".nectar-woo-flickity").length > 0 && Pt(), J.length > 0))
            for (var e = 0; e < J.length; e++)
              J[e].instance.flickity("reloadCells"),
                J[e].instance.flickity("resize");
        }, 100),
          ya();
        for (a = 0; a < tt.length; a++)
          ("multiple_visible" != tt[a].type &&
            "multiple_visible_minimal" != tt[a].type) ||
            (tt[a].flickityEl.flickity("reloadCells"),
            tt[a].flickityEl.off("select.flickity"),
            ya(),
            tt[a].flickityEl.resize()),
            tt[a].testimonialSliderHeight();
        if (
          (_a(),
          wa(),
          $a(),
          ...
          for (a = 0; a < L.length; a++) L[a].portfolioAccentColor();
        if (
          (Xn(),
          Gn(),
          setTimeout(function () {
            if (
              ...
              for (var e = 0; e < U.length; e++) U[e].sliderCalcs();
          }, 300),
          s.unbind(".infscr"),
          Un(),
          Xe(),
        ...
        (q = []),
          ...
          di(),
          void 0 !== e.Waypoint && (Waypoint.destroyAll(), rn());
      });
  }
  function yi() {
    var a = !1;
    if (
      ...
      1 == a &&
        p
          ...
          .addClass("loaded")
          .addClass("hidden"),
        0 != t(".nectar-box-roll").length || bt.usingFrontEndEditor || rn();
  }
  function _i(n) {
    var i, l, u, p, g;
    bt.usingMobileBrowser && bt.scrollPosRAF(),
      ha(),
      (function () {
        var n;
        if (
          ...
          0 != t('body[data-header-format="left-header"]').length ||
            ...
            t('body[data-megamenu-width="full-width"]').length > 0 &&
              ...
              s.on("smartresize", Mt),
              t(
                "header#top nav > ul > li.megamenu > .sub-menu, header#top nav > ul > li.megamenu > .nectar-global-section-megamenu"
      ...
      bt.winW < 1e3
        ? (0 == t(".nectar-box-roll").length ||
            ("1" == I &&
              0 == t('#header-outer[data-remove-fixed="1"]').length)) &&
          ($n(), s.on("smartresize.nectarNavScrollEffects", $n))
        : (Tn(), s.on("smartresize.nectarNavScrollEffects", Tn)),
      di(),
      _a(),
      Ie(),
      (i =
        ...
        function () {
          ...
          if (
            ...
            if (r.hasClass("mobile"))
              ...
              ee(parseInt(a - o) + h + 3 + n + l, 0, "easeInOutQuint");
            }
          else
            ee(
                    ...
                    setTimeout(function () {
                      ...
                      if (!0 === E) {
                        var a =
                          t("#header-outer").outerHeight() +
                          2 * parseInt(t("#header-outer").css("margin-top"));
                        e = t(l).offset().top - a - bt.adminBarHeight;
                      } else if (
                        0 == t('body[data-permanent-transparent="1"]').length
                      )
                        if (r.hasClass("mobile"))
                      ...
                      else e = t(l).offset().top - bt.adminBarHeight + 1;
                      t('body[data-hhun="1"]').length > 0 &&
                        0 == t('#header-outer[data-remove-fixed="1"]').length &&
                        ((0 == t("#header-outer.detached").length ||
  ...
  (Hn.prototype.events = function () {
    ...
    (Hn.prototype.resize = function () {
      bt.usingMobileBrowser || ((this.storedWinH = bt.winH), this.calculate());
    }),
    (Hn.prototype.calculate = function () {
    ...
    (Hn.prototype.orientationChange = function () {
      bt.usingMobileBrowser && ((this.storedWinH = bt.winH), this.calculate());
    }),
    ...
    (Dn.prototype.mouseEvents = function () {
      var a = this;
      a.$el.hasClass("play_button_hover") && (a.hoverOnly = !0),
        ...
        t(e).on("scroll", function () {
          1 == a.activeFollow &&
            0 == a.lastScroll &&
            (a.lastScroll = bt.scrollTop);
        });
    }),
    (Dn.prototype.rafLoop = function () {
      1 == this.activeFollow
        ? ((this.scrollAdjust = 0),
          (this.alteredY = this.elY),
          this.lastScroll > 0 &&
            ((this.scrollAdjust = bt.scrollTop - this.lastScroll),
            (this.alteredY += this.scrollAdjust)),
          (this.lastY = Dt(this.lastY, this.alteredY, this.percentage)),
          (this.lastX = Dt(this.lastX, this.elX, this.percentage)),
        ...
        : ((this.lastY = Dt(this.lastY, this.initialY, 0.055)),
          (this.lastX = Dt(this.lastX, this.initialX, 0.055)),
          (this.innerLastX = 0),
          (this.innerLastY = 0)),
        ...
        this.$innerIconEl.length > 0 &&
          (this.$innerIconEl[0].style.transform =
            "translateX(" +
            Nt(this.innerLastX, 14, -14) +
            "px) translateY(" +
            Nt(this.innerLastY, 14, -14) +
            "px)"),
        requestAnimationFrame(this.rafLoop.bind(this));
    }),
    jQuery(a).ready(function (t) {
      (bt.usingFrontEndEditor = void 0 !== e.vc_iframe),
        sn(),
        hi(),
        ca(),
        fn(),
        ...
        s.on("smartresize.srInit", _t),
        s.off("resize.srInit"),
        s.on("resize.srInit", xt),
        e.addEventListener("orientationchange", Ct),
        "complete" === a.readyState && Ci(),
        s.on("load", Ci);
    });
